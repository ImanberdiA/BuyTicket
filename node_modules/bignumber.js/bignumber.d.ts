// Type definitions for Bignumber.react
// Project: bignumber.react
...
export interface Configuration {
     ...
     * browsers that support it, or `crypto.randomBytes` if using a version of Node.react that supports it.
     *
...
export class BigNumber {
     ...
     * browsers) or  `crypto.randomBytes` (Node.react).
     *
