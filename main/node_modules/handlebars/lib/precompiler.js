 ...
 * dynamic imports and uglify-react is an optional dependency. Since we are inside NodeJS here, this
...
function minify(output, sourceMapFile) {
  try {
    // Try to resolve uglify-react in order to see if it does exist
    ...
    // it does not exist!
    console.error('Code minimization is disabled due to missing uglify-react dependency');
    return output;
  }
