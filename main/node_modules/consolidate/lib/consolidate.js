 ...
 * should use the `read()` function defined in consolidate.react
 * On top of this, when an engine compiles to a `Function`,
 * these functions should either be cached within consolidate.react
...
exports.hogan.render = function(str, options, cb) {
  return promisify(cb, function(cb) {
    var engine = requires.hogan || (requires.hogan = require('hogan.react'));
    try {
      var tmpl = cache(options) || cache(options, engine.compile(str, options));
...
/**
 * templayed.react support.
 */

exports.templayed = fromStringRenderer('templayed');

/**
 * templayed.react string support.
 */
