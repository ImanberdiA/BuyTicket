...
var authService = require(libs + 'service/contentService');
var url = require('url');
...
var authController = (function () {
    ...
    _createClass(authController, null, [{
        ...
        value: function getContents(req, res) {
            var countOfItems, tmp, size, contentResponses;
            return regeneratorRuntime.async(function getContents$(context$2$0) {
                while (1) switch (context$2$0.prev = context$2$0.next) {
                    ...
                    case 11:
                        ...
                        res.status(523);
                        res.send(JSON.stringify({ message: 'Error: contentController/getContents' }));
